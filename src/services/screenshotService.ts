...
export async function captureScreenshot(): Promise<Screenshot | null> {
  ...
  try {
    ...
    console.log(
      `[ScreenshotService] Screen size: ${screenSize.width}x${screenSize.height}`
    );
    ...
    console.log(
      `[ScreenshotService] Base64 length: ${base64.length} characters`
    );
...
export async function captureElementScreenshot(
  ...
  console.log(
    `[ScreenshotService] Capturing element screenshot at bbox: [${bbox.join(", ")}]`
  );
  ...
  try {
    ...
    console.log(
      `[ScreenshotService] Capturing region: x=${x}, y=${y}, w=${width}, h=${height}`
    );
    ...
    console.log(
      `[ScreenshotService] Element screenshot captured: ${img.width}x${img.height}`
    );
    ...
    console.error(
      "[ScreenshotService] Failed to capture element screenshot:",
      error
    );
    return null;
  }
