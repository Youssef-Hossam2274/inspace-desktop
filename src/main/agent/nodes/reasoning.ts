...
export async function reasoningNode(
  ...
  console.log(
    `[Reasoning] Starting reasoning node - Iteration ${state.iteration_count}`
  );
  try {
    ...
    console.log(
      `[Reasoning] Perception result has ${state.perception_result.elements.length} elements`
    );
    const context = {
    ...
    console.log(
      "[Reasoning] Sending context to LLM for action plan generation..."
    );
    console.log(
      `[Reasoning] Available UI elements: ${state.perception_result.elements.length}`
    );
    ...
    console.log(
      `[Reasoning] Generated action plan with ${actionPlan.actions.length} actions`
    );
    console.log(`[Reasoning] Next action directive: ${actionPlan.next_action}`);
    actionPlan.actions.forEach((action, index) => {
      console.log(
        `[Reasoning] Action ${action.step_id}: ${action.action_type} - ${action.description}`
      );
    });
